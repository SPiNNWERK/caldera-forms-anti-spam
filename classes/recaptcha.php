...
class CF_Antispam_Recaptcha {
    ...
    /**
     * Modify field attributes so recaptcha field has type "text" not "recaptcha" and hide if from UI
     *
     * @since 0.1.0
     *
    ...
    public function field_attrs( $attrs, $form ){
        ...
        $attrs['data-parsley-trigger'] = 'input';
        return $attrs;
    }

    /**
     * Check that the recaptcha response is sent on forms that have a recaptcha field.
     *
     * @since 0.1.0
     *
